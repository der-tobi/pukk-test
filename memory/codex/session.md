...
- Implemented last-five-minutes disco mode for checked-in current meetings. During the final five minutes, only LED index 0 cycles pink/cyan/white/purple at the poll cadence; unchecked bookings stay orange and provisional button blue still overrides disco. Rebuilt `pukk-test.exe`; SHA-256 is `a4e748678297990b448cb4324f523d664eaae627a9f688073e254386c80ebbda`.
...
- Live-test disco mode in the final five minutes of a checked-in booking. Expected: only physical LED 1 / code index 0 changes color at each poll; other LEDs continue to show free/upcoming state normally.
